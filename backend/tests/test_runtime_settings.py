...
def test_default_daily_bitbucket_refresh_uses_nine_in_owl_timezone():
    assert settings.BITBUCKET_APP_DAILY_REFRESH_LOCAL_HOUR == 9
    assert settings.TIME_ZONE == "Europe/Dublin"


def test_default_bitbucket_inventory_holds_five_hundred_pages():
