...
def _is_local_mutation(request: HttpRequest) -> bool:
    ...
    if match is None:
        try:
            ...
            return False
    return match.view_name in _LOCAL_MUTATIONS
...
def _may_accept_opaque_origin(request: HttpRequest) -> bool:
    ...
    exception remains limited to named local POST actions over loopback
    ...
    return bool(
        ...
        and _is_local_mutation(request)
    )
