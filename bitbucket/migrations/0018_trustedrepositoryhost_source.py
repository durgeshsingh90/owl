...
def backfill_referenced_hosts(apps, schema_editor):
    ...
    Credential = apps.get_model("bitbucket", "BitbucketHTTPSCredential")
    TrustedHost = apps.get_model("bitbucket", "TrustedRepositoryHost")
    candidates = {
        normalized
        for value in (
...
class Migration(migrations.Migration):
    dependencies = [("bitbucket", "0017_adaptive_pdf_pipeline")]
