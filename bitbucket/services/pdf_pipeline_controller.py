...
from bitbucket.models import PDFPipelineRecoveryState, PDFPipelineTuningAction
...
def admission_target_from_owner_snapshot(*, at: datetime | None = None) -> int:
    ...
    target = Path(settings.BITBUCKET_APP_PIPELINE_STATE_ROOT) / METRICS_SNAPSHOT_FILENAME
    try:
...
class PDFPipelineController:
    ...
    def _record(
        ...
        *,
        ...
        from bitbucket.models import PDFPipelineTuningEvent
