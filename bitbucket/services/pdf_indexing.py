...
from bitbucket.services import pdf_jsonl_staging as pdf_jsonl
from bitbucket.services.document_actions import DocumentActionError, validated_pdf_path
from bitbucket.services.filesystem_paths import filesystem_path
from bitbucket.services.logging_events import get_logger, log_event, logging_context
from bitbucket.services.operation_logs import (
    append_operation_log_entry_safely,
    build_operation_log_entry,
)
from bitbucket.services.pdf_extractor import (
    DIAGNOSTIC_REASONS,
    DIAGNOSTIC_STAGES,
    PDF_EXTRACTOR_VERSION,
    PDFExtractionDiagnostic,
)
from bitbucket.services.pdf_pipeline_control import (
    extraction_admission_allowed,
    publication_admission_allowed,
)
from bitbucket.services.pdf_pipeline_runs import reconcile_run_repository
...
def run_isolated_pdf_extractor(
    ...
    *,
    ...
    temp_root = Path(settings.BITBUCKET_APP_TEMP_ROOT).resolve()
    try:
    ...
    with output_file as output:
        try:
            ...
            process = subprocess.Popen(
                [sys.executable, "-m", "bitbucket.services.pdf_extractor"],
