...
from bitbucket.services.foreground_metrics import foreground_latency_snapshot
from bitbucket.services.pdf_jsonl_staging import staging_directory, staging_snapshot
from bitbucket.services.pdf_pipeline_controller import (
...
def _recovery_snapshot() -> dict[str, Any]:
    ...
    from bitbucket.services.pdf_recovery import recovery_payload
...
def _snapshot_path() -> Path:
    return Path(settings.BITBUCKET_APP_PIPELINE_STATE_ROOT).resolve() / SNAPSHOT_FILENAME
