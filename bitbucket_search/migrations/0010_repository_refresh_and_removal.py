...
_fts = import_module("bitbucket_search.migrations.0004_pdf_fts_indexes")
...
def move_file_exclusions_to_repositories(apps, schema_editor):
    ...
    policy = apps.get_model("bitbucket_search", "PDFLocalPolicy")
...
class Migration(migrations.Migration):
    dependencies = [("bitbucket_search", "0009_repository_git_output")]
