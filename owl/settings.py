...
BITBUCKET_APP_REPOSITORIES_ROOT = REPOSITORIES_ROOT / "bitbucket-app"
...
BITBUCKET_APP_CONNECTION_TIMEOUT_SECONDS = min(
    _env_int("BITBUCKET_APP_CONNECTION_TIMEOUT_SECONDS", 30, minimum=1),
    120,
)
BITBUCKET_APP_GIT_TIMEOUT_SECONDS = _env_int(
    "BITBUCKET_APP_GIT_TIMEOUT_SECONDS",
    3_600,
    minimum=60,
)
BITBUCKET_APP_DAILY_PULL_ENABLED = _env_bool("BITBUCKET_APP_DAILY_PULL_ENABLED", True)
BITBUCKET_APP_DAILY_PULL_LOCAL_HOUR = _env_int(
    "BITBUCKET_APP_DAILY_PULL_LOCAL_HOUR",
    9,
    minimum=0,
)
if BITBUCKET_APP_DAILY_PULL_LOCAL_HOUR > 23:
    raise ImproperlyConfigured("BITBUCKET_APP_DAILY_PULL_LOCAL_HOUR must be between 0 and 23.")
