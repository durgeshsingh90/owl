...
_LOCAL_BITBUCKET_MUTATIONS = frozenset(
    {
        ...
        "bitbucket:people_group_create",
        "bitbucket:people_star_toggle",
        "bitbucket:document_star",
        "bitbucket:document_preview",
        "bitbucket:document_open",
        "bitbucket:documents_open_all",
        "bitbucket:document_reveal",
        "bitbucket:document_exclude",
        "bitbucket:document_resume",
        "bitbucket:document_delete",
        "bitbucket:repository_add",
        "bitbucket:repository_exclude",
        "bitbucket:repository_remove",
        "bitbucket:repositories_selected",
        "bitbucket:repository_refresh",
        "bitbucket:repository_schedule_tick",
        "bitbucket:repositories_refresh_all",
        "bitbucket:pdf_pipeline_recovery_popup_claim",
        "bitbucket:pdf_pipeline_recovery_popup_acknowledge",
        "bitbucket:pdf_pipeline_recovery_resume",
